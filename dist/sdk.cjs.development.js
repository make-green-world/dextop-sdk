...
var FACTORY_ADDRESS = '0xf24e8058fa469900de82F8752D5bdAb655205B98';
var INIT_CODE_HASH = '0x21bd7484b58413a2844dd75c65d3ef6c95e5fe9da7b6b878dfbffc565140d9cf';
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'PLS', 'PulseChain');
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xA1077a294dDE1B09bB078844df40758a5D0f9a27', 18, 'WPLS', 'Wrapped Pulse'), _WETH);
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          methodName = useFeeOnTransfer ? 'swapExactPLSForTokensSupportingFeeOnTransferTokens' : 'swapExactPLSForTokens'; // (uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForPLSSupportingFeeOnTransferTokens' : 'swapExactTokensForPLS'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case exports.TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = 'swapPLSForExactTokens'; // (uint amountOut, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = 'swapTokensForExactPLS'; // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
